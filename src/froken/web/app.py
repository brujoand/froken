...
from froken.auth.cookies import CookieCodec
from froken.auth.oidc import OidcClient
from froken.catalogue.loader import Catalogue
from froken.config import Settings
from froken.config import settings as env_settings
from froken.items.loader import ItemBank
from froken.quiz.session import SessionStore
from froken.scores.store import AttemptStore
from froken.web.admin_routes import router as admin_router
from froken.web.auth_routes import router as auth_router
...
def create_app(
    ...
    # provider does not have to be up before Frøken is.
