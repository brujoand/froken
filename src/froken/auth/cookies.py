...
LOGIN_COOKIE = "froken_session"
FLOW_COOKIE = "froken_login_flow"
...
class CookieCodec:
    """Signs and reads Frøken's two cookies with one secret, two salts.
    ...
    def __init__(self, secret: str) -> None:
        self._login = URLSafeTimedSerializer(secret, salt="froken-login")
        self._flow = URLSafeTimedSerializer(secret, salt="froken-login-flow")
